...
//     extends State<ConfigurableExpansionTile>
...
//         duration: widget.kExpand, vsync: this);
//     _heightFactor = _controller!
//         .drive(ConfigurableExpansionTile._easeInTween);
//     _iconTurns = _controller!.drive(
//         (widget.animatedWidgetTurnTween ??
//                 ConfigurableExpansionTile._halfTween)
//             .chain(widget.animatedWidgetTween ??
//                 ConfigurableExpansionTile._easeInTween));

//     _borderColor = _controller!.drive(_borderColorTween
//         .chain(widget.borderAnimationTween ??
//             ConfigurableExpansionTile._easeOutTween));
//     _borderColorTween.end = widget.borderColorEnd;

//     _headerColor = _controller!.drive(_headerColorTween
//         .chain(widget.headerAnimationTween ??
//             ConfigurableExpansionTile._easeInTween));
...
//           .writeState(context, _isExpanded);
//     });
...
//         _borderColor!.value;
//     final Color headerColor = _headerColor?.value ??
//         widget.headerBackgroundColorStart;
//     return Container(
//       decoration: BoxDecoration(
//           border: Border(
//         top: BorderSide(
//             color: widget.topBorderOn
//                 ? borderSideColor
//                 : Colors.transparent),
//         bottom: BorderSide(
//             color: widget.bottomBorderOn
//                 ? borderSideColor
//                 : Colors.transparent),
//       )),
//       child: Column(
...
//     final bool closed =
//         !_isExpanded && _controller!.isDismissed;
