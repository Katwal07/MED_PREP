...
class SubjectListingMajor extends StatefulWidget {
  String SelectedTab;
  SubjectListingMajor({required this.SelectedTab});
  @override
  _SubjectListingMajorState createState() => _SubjectListingMajorState();
}

class _SubjectListingMajorState extends State<SubjectListingMajor> {
  @override
