...
import 'package:med_prep/enums/viewstate.dart';
...
class SubjectListingShort extends StatefulWidget {
  String SelectedTab;
  SubjectListingShort({required this.SelectedTab});
  @override
  _SubjectListingShortState createState() => _SubjectListingShortState();
}

class _SubjectListingShortState extends State<SubjectListingShort> {
  @override
